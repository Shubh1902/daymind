    ...
    <div className="animate-fade-in pb-24">
      ...
      <div className="flex items-center justify-between mb-6 animate-slide-up">
        ...
        <div className="flex gap-2">
          <Link
            href="/closet/outfits"
            className="text-sm font-semibold px-4 py-2.5 rounded-xl flex items-center gap-2 transition-all duration-200"
            style={{
      ...
      <div className="animate-slide-up delay-100">
        <ClosetGrid initialItems={items as unknown as Parameters<typeof ClosetGrid>[0]["initialItems"]} />
      </div>
    </div>
  )
}
